...
if pca == 0
    ...
    load(modelFileName, 'RF_PCA_Model', 'eigenVectors', 'meanX');
    fprintf('Model loaded %s', modelFileName);
end
...
for i = 1:length(testImages)
    ...
    % Run detector
    if pca == 0
        [detections, scores] = rf_sliding_window(image, forest, 0.95);
    else
        [detections, scores] = rf_sliding_window_pca(image, RF_PCA_Model, eigenVectors, meanX, 0.55 ...
            ...
            ...
            );
    end
