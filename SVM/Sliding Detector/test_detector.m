...
% save('trained_svm_model_fullImage_6040_withHE', 'svmModel') after running
% the SVM_fullImage_6040 script
load('trained_svm_model_fullImage_6040_withHE.mat', 'svmModel');
...
for i = 1:length(testImages)
    ...
    image = histeq(image);
    % Run detector
    [detections, scores] = sliding_window_fullImage(image, svmModel);
